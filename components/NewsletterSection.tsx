...
const NewsletterSection = () => {
  ...
  return (
    <section className="w-full py-16 p-4 bg-white flex justify-center">
      <div className="w-full max-w-7xl mx-auto bg-[#F6F7FB] rounded-2xl shadow-md flex flex-col-reverse md:flex-row overflow-hidden">
        ...
        <div className="p-4 md:p-10 lg:p-16 flex flex-col justify-center">
          ...
          <form onSubmit={submitHandler} className="mt-8 flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="mt-3 w-full md:w-40 px-6 py-3 rounded-lg bg-black text-white font-medium transition duration-300 ease-in-out hover:bg-gray-900 active:scale-95"
            >
              Sign Up
            </button>
          </form>
        ...
        <div className="w-full h-72 lg:h-full relative">
          <Image
            src="/assets/images/cardfrontside.webp" // updated path
            alt="News Car"
            fill
            className="object-cover rounded-b-2xl lg:rounded-b-none lg:rounded-r-2xl"
